"""Functions to read raw file formats such as .xrdml, .rasx are added here."""
...
from pynxtools_xrd.utils import (
    detect_scan_type,
    modify_scan_data,
)
from pynxtools_xrd.ikz import RASXfile, BRMLfile

from pint import UnitRegistry

ureg = UnitRegistry()

formats = [".rasx", ".xrdml", ".brml"]
...
def read_panalytical_xrdml(
    ...
    return {
        ...
        "countTime": modified_scan_data["count_time"],
